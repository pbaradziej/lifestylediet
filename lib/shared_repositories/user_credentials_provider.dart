...
class UserCredentialsProvider extends SharedPreferencesProvider {
  ...
  Future<String> readUid() async {
    return withPreferences<String>((SharedPreferences preferences) {
      return preferences.getString(_uidKey) ?? '';
    });
  }

  Future<void> clearUid() async {
    return withPreferences<void>((SharedPreferences preferences) {
      preferences.remove(_uidKey);
    });
  }

  Future<void> saveEmail(String uid) async {
    await withPreferences<void>((SharedPreferences preferences) async {
